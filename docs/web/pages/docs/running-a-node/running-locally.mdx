## Running a Local Blackfury Ethereum Cosmos-SDK Chain
...
The easiest way to install a Cosmos-SDK Blockchain running Blackfury Ethereum is to download a pre-built binary. You can find the latest binaries on the [releases](https://github.com/berachain/polaris/releases) page.

### From Source

**Step 1: Install Golang & Foundry**

Go v1.20+ or higher is required for Blackfury Ethereum
...
[Foundry](https://book.getfoundry.sh/getting-started/installation) is required for Blackfury Ethereum
...
**Step 2: Get Blackfury Ethereum source code**
