...
Blackfury Ethereum welcomes contributions to its source code from anyone in the community, 
...
the [Blackfury Ethereum Github Issues] first to ensure that your changes align with the project's 
philosophy and to get some early feedback that can make the review and merge process 
smoother for both parties.

It's important that your contributions adhere to Blackfury Ethereum's coding guidelines, which 
include:
...
All pull requests will be reviewed based on the Blackfury Ethereum's code review guidelines.

Blackfury Ethereum also encourages an early pull request approach, where contributors create pull 
...
[Blackfury Ethereum Github Issues]:https://github.com/berachain/polaris/issues