...
/**
 * @notice Blackfury implementation of ERC20 + EIP-2612.
 *
 * The BlackfuryERC20 token is used as the ERC20 token representation of IBC-originated coins on
 * Cosmos SDK Blackfury chains. Uses the bank module to actually hold account balances and execute
 * transfers. The authz module is used to set approvals and permissions for spends.
 *
 * @author Berachain Team
 * @author Solmate (https://github.com/Rari-Capital/solmate/blob/main/src/tokens/ERC20.sol)
 */
contract BlackfuryERC20 is IERC20 {
    /*//////////////////////////////////////////////////////////////
                              ERC20 STORAGE
    //////////////////////////////////////////////////////////////*/
    ...
    function approve(address spender, uint256 amount) public virtual returns (bool) {
        require(
            ...
            "BlackfuryERC20: failed to approve spend"
        );
    ...
    function transfer(address to, uint256 amount) public virtual returns (bool) {
        require(bank().send(msg.sender, to, amountToCoins(amount)), "BlackfuryERC20: failed to send tokens");
    ...
    function transferFrom(address from, address to, uint256 amount) public virtual returns (bool) {
        require(amount <= authz().getSendAllowance(from, msg.sender, denom), "BlackfuryERC20: insufficient approval");
        require(bank().send(from, to, amountToCoins(amount)), "BlackfuryERC20: failed to send bank tokens");
    ...
    function permit(address owner, address spender, uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s)
        ...
        virtual
    {
        require(deadline >= block.timestamp, "BlackfuryERC20: PERMIT_DEADLINE_EXPIRED");
        ...
        unchecked {
            ...
            require(recoveredAddress != address(0) && recoveredAddress == owner, "BlackfuryERC20: INVALID_SIGNER");
