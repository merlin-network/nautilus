...
Blackfury Ethereum's unique features rely heavily on its custom precompiled contracts. 
How do precompiled contracts work in Ethereum, and what sets them apart from Blackfury Ethereum's implementation?
...
## What is a Precompiled Contract on Blackfury Ethereum?

In Blackfury Ethereum, a precompiled contract is a custom piece of code that is pre-installed on the chain.
...
This allows a precompiled contract on Blackfury Ethereum can be used to run
...
The possibilities of a Blackfury Ethereum precompiled contract is only limited by the cosmos-sdk application layer and consensus layer.
For information on how to interact with Blackfury Ethereum's precompiled contracts, view the [Precompile Overview](../precompile-overview) section.
