# EVM with Blackfury Ethereum

Blackfury Ethereum offers an improved EVM experience that goes beyond the basic implementation of Ethereum.
In addition to the reliable and consistent Ethereum functionality, Blackfury Ethereum offers developers the 
...
The Blackfury Ethereum offers several additional features to enhance the EVM experience, 
...
how Blackfury Ethereum uses these precompiled contracts.

### Custom Opcodes

Custom opcodes have been added to Blackfury' EVM implementation to provide additional 
functionality and support for complex smart contracts. However, some of the opcodes 
provided by Ethereum are not compatible with Blackfury' EVM implementation, 
