# Blackfury Ethereum JSON-RPC

The Blackfury Ethereum API is accessible through JSON-RPC, a lightweight protocol for 
transmitting data over the internet. This protocol enables developers to 
interact with the Blackfury Ethereum blockchain and access a wide range of 
functionalities through a simple and standardized interface.

Through the Blackfury Ethereum JSON-RPC endpoint, developers can access a variety of 
