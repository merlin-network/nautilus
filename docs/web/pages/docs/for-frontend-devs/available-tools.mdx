...
There are a number of available tools for frontend dApp developers building on Blackfury Ethereum. Being an
EVM compatible chain, it's tool set is interoperable with the broader EVM ecosystem.
Here are a few of the tools available for Blackfury Ethereum:
...
To highlight the improved user experience Blackfury Ethereum's [Stateful Precompiles](../precompile-overview)
